		...
		<div bind:this={codeRef} class="w-screen overflow-scroll pl-2">
			...
			<HtmlTag tagName="AboutMe">
				<HtmlTag tagName="img" values={[{ name: 'src', value: 'me.jpg' }]}>
					<img class="ml-6 w-96 rounded-full" src="{assets}/yo.jpg" alt="Me" />
				</HtmlTag>
				<p class="pr-4">
					...
					love video games, music, nature, travel and adventures.
				</p>
			...
			<HtmlTag tagName="Skills">
				<p>
					<span class="text-red-400">I'm a multi paradigms developer</span>, web developing, compute
					graphics and some knowledge about networking, relational databases and backend.
				</p>
